            ...
            <tr>
                <td>
                                                            ...
                                                            <td class="pad" style="width:100%;">
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <!-- <div style="max-width: 600px;"><img
                                                                            ...
                                                                            src="{{ asset('assets/images/mail/animated_header.gif') }}"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #d9dffa; background-image: url('{{ asset('assets/images/mail/body_background_2.png') }}'); background-position: top center; background-repeat: repeat;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                ...
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#506bec;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:30px;line-height:120%;text-align:center;mso-line-height-alt:45.6px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong><span>Verify Your Email Address</span></strong></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:18px;font-weight:700;line-height:120%;text-align:center;mso-line-height-alt:21.599999999999998px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Hey, thanks for signing up!</span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;line-height:120%;text-align:center;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Confirm your account by clicking the link below:</span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                        ...
                                                                        target="_blank"><span
                                                                            style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break:break-word;"><span
                                                                                    data-mce-style=""
                                                                                    style="line-height: 30px;"><strong>Verify Now</strong></span></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad" style="width:100%;">
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <!-- <div style="max-width: 600px;"><img
                                                                            ...
                                                                            src="{{ asset('assets/images/mail/bottom_img.png') }}"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
