            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="name" name="name" value={resume.profile.name} onChange={handleInputChange} placeholder="John Doe" required />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email">Email</Label>
                    <Input id="email" name="email" type="email" value={resume.profile.email} onChange={handleInputChange} placeholder="johndoe@example.com" required />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="phone">Phone</Label>
                    <Input id="phone" name="phone" type="tel" value={resume.profile.phone} onChange={handleInputChange} placeholder="+1 (555) 123-4567" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="location">Location</Label>
                    <Input id="location" name="location" value={resume.profile.location} onChange={handleInputChange} placeholder="City, State, Country" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="summary" name="summary" value={resume.profile.summary} onChange={handleInputChange} placeholder="Write a brief summary of your professional experience and skills..." className="min-h-[100px]" />
                </div>
              </div>
                  ...
                  <div key={index} className="mb-4 p-4 border rounded-md">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id={`position-${index}`} value={workExperience.jobTitle} onChange={(e) => handleWorkExperienceChange(index, "position", e.target.value)} placeholder="Job title" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor={`startDate-${index}`}>Start Date</Label>
                        <Input id={`startDate-${index}`} value={workExperience.date} onChange={(e) => handleWorkExperienceChange(index, "startDate", e.target.value)} placeholder="Start date" />
                      </div>
                    </div>
                    <div className="mt-4">
              ...
              <div>
                ...
                <Textarea value={resume.skills.descriptions.join(", ")} onChange={handleSkillsChange} placeholder="Enter skills separated by commas" className="min-h-[80px]" />
              </div>
            </div>
          </form>
        </CardContent>
