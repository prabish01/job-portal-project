...
const Docubutton = () => {
  return (
    <>
      <div className="Documents-btn p-5 hover:bg-gray-50 flex flex-col border align-middle items-center place-content-center">
        ...
        <p className="docutxt">Drag or upload your resume</p>
      </div>
    </>
  );
};

export default Docubutton;
