...
export default function Page() {
  ...
  const onSubmit = async (values: ResetValues) => {
    ...
    setPending(true);
    try {
      const resetResponse = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/employer/forgot-password`, {
        method: "POST",
        headers: {
  ...
  const verifyToken = async (token: string) => {
    try {
      const tokenResponse = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/employer/verify-token`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const onOtpSubmit = async (otp: OtpValues) => {
    ...
    try {
      const otpResponse = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/employer/verify-otp`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const onNewPasswordSubmit = async (values: NewPasswordValues) => {
    ...
    try {
      const passwordResponse = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/employer/reset-password`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
