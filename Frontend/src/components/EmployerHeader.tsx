          ...
          <nav className="flex items-center justify-between align-middle h-16">
            ...
            <ul className="flex space-x-16">
              ...
              <li className="relative hover:text-blue-500 group">
                <a href="#" className="text-sm flex items-center h-16  transition-colors">
                  Services
                  <svg className="w-4 h-4 ml-1 transition-transform duration-200 group-hover:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
            ...
            {session ? (
              ...
              <ul className="">
                <li className="relative hover:text-blue-500  transition-all group">
                  <Button variant="default" className="bg-blue-500 group-hover:bg-blue-600 transition-colors">
                    <span className="mr-2">
                      <LogIn />
                    </span>{" "}
                    Login
                  </Button>
                  <div className="absolute left-0 mt-3 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                      <a href="/admin/login" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                        Login as Admin
                      </a>
                      <a href="/jobseeker/signin" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                        Login as Job Seeker
                      </a>
                      <a href="/employer/signin" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                        Login as Employer
                      </a>
                    </div>
                  </div>
